...
icon_path = "C:/Users/Akshay/OneDrive/Desktop/GUVI_Projects/BizCard/ocr.png"
st.set_page_config(
    page_title="BizCardX: EXTRACTING BUSINESS CARD DATA With OCR | By Akshay Kumar",
    page_icon=icon_path,
    layout="wide",
    initial_sidebar_state="expanded",
    menu_items={'About': """# This OCR app is created by *Akshay Kumar*!"""}
)

# Displaying the title using Markdown
st.markdown("""
...
if selected == "Upload & Extract":
    ...
    if uploaded_card is not None:
        def save_card(uploaded_card):
            ...
            os.makedirs(uploaded_cards_dir, exist_ok=True)  # Create directory if it doesn't exist
        ...
        data = {"company_name": [], "card_holder": [], "designation": [], "mobile_number": [], "email": [],
                "website": [], "area": [], "city": [], "state": [], "pin_code": [], "image": img_to_binary(saved_img)}
